...
static const char *fonts[]          = { "Victor Mono:size=12" };
static const char dmenufont[]       = "Victor Mono:size=12";
//background color
...
static const char col_gray4[]       = "#586e75";
...
static const char *colors[][3]      = {
	...
	[SchemeTagsSel]  = { col_gray4, col_cyan,  "#d33682"  }, // Tagbar left selected {text,background,not used but cannot be empty}
...
static const Rule rules[] = {
	...
	{ "librewolf-bin",  NULL,       NULL,       1 << 4,       1,           -1 },
